...
public class Game
{
    ...
    private void setCurrentPlayer(Player currentPlayer)
    {
        ...
        if (currentPlayer.equals(oldValue)) //Force event
        {
            oldValue = null;
        }
        prop.firePropertyChange(CURRENT_PLAYER_PROPERTY, oldValue,
                currentPlayer);
    }
    ...
    public boolean chooseScoreType(ScoreType scoreType)
    {
        ...
        Score s = ScoreFactory.findScore(scoreType,
                unusedScores.get(currentPlayer));
        if (s == null)
        {
            return false;
        }
        ...
        int leftForBonus = ScoreFactory.getLeftForBonus(
                currentPlayer.getScores());
    ...
    public boolean nextRound()
    {
        ...
        if (scoreList == null)//Game has ended once befoure
        {
            return false;
        }
        ...
        prop.firePropertyChange(WAITING_FOR_ACTION_EVENT, null,
                EVENT_CHOOSE_SCORE);
